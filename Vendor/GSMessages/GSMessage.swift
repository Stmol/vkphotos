...
public enum GSMessageType: String
{
...
//        }
        ...
        if inView.installedMessage != nil && inView.installedMessage?.type == type {
            return
        }
    ...
    public private(set) var type: GSMessageType
    ...
    public private(set) var hideHandler: (() -> ())?
    ...
    public init(attributedText: NSAttributedString,
        ...
        for option in options ?? [] {
            switch (option) {
                ...
                case let .hideHandler(value): hideHandler = value
            }
        }
        ...
        switch position {
            ...
            case .top:
                ...
                if let vc = inViewController {
                    ...
                    if !isNavBarHidden && isNavBarTranslucent && !isStatusBarHidden {
                        offsetY += statusBarHeight
                    }
                    if !isNavBarHidden && isNavBarTranslucent {
...
extension GSMessage
{
    ...
    public override func observeValue(forKeyPath keyPath: String?, of object: Any?, change: [NSKeyValueChangeKey: Any]?,
